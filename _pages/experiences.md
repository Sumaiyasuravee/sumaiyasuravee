...
<div class="list__item">
  <article class="archive__item">
    ...
    <p class="page__meta"><i class="fas fa-fw fa-building-columns" aria-hidden="true"></i> University of Greifswald, Germany &middot; April 2026 &ndash; Present</p>
    <ul>
...
<div class="list__item">
  <article class="archive__item">
    ...
    <p class="page__meta"><i class="fas fa-fw fa-building-columns" aria-hidden="true"></i> Greifswald University Medicine, Germany &middot; January 2026 &ndash; March 2026</p>
    <ul>
...
<div class="list__item">
  <article class="archive__item">
    <h2 class="archive__item-title">Research Associate</h2>
    <p class="page__meta"><i class="fas fa-fw fa-building-columns" aria-hidden="true"></i> University of Greifswald, Germany &middot; December 2022 &ndash; December 2025</p>
    <ul>
...
<div class="list__item">
  <article class="archive__item">
    <h2 class="archive__item-title">Research Associate</h2>
    <p class="page__meta"><i class="fas fa-fw fa-building-columns" aria-hidden="true"></i> University of Rostock, Germany &middot; July 2020 &ndash; November 2022</p>
    <ul>
...
<div class="list__item">
  <article class="archive__item">
    ...
    <p class="page__meta"><i class="fas fa-fw fa-building-columns" aria-hidden="true"></i> Planet AI GmbH, Rostock, Germany &middot; October 2019 &ndash; June 2020</p>
    <ul>
...
<div class="list__item">
  <article class="archive__item">
    ...
    <p class="page__meta"><i class="fas fa-fw fa-building-columns" aria-hidden="true"></i> PIA care, Rostock, Germany &middot; October 2018 &ndash; March 2019</p>
    <ul>
      <li>Worked on a project on automatic face detection for video-based intention recognition.</li>
      <li>Identified and recognised faces from images and videos using deep learning-based algorithms (Faster R-CNN and Single Shot Multibox Detector).</li>
    </ul>
  </article>
</div>
